...
<%@page import="Controller.ReservationDAO,Model.ReservationBean,java.util.*"%>
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
<%
    List<ReservationBean> list = ReservationDAO.getUnconfirmedRecords();
                                            ...
                                            <tr>
                                                ...
                                                <td>   
                                                    <div class="d-flex justify-content-between">
                                                        <a href="manageUnconfirmed.jsp?id_reservation=${r.getId_reservation()}" class="btn btn-warning btn-icon-split" style="margin-right: 5px;">
                                                            <span class="text">Manage</span>
                                                        </a>
                                                            <a href="unconfirmedTable.jsp"></a>
                                                        <a href="deleteUnconfirmed.jsp?id_reservation=${r.getId_reservation()}" class="btn btn-danger btn-icon-split">
